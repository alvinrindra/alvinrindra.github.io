        ...
        function ($scope, $q, $rootScope, graphProperties, EntityService, _, $mdDialog, $mdToast, $timeout) {
          ...
          $scope.buildGraph = function() {
              ...
              var nodes = [
                ...
                { data: { id: 'ai_specialist', name: "Senior AI & Data", parent: 'working_exp', desc: "Almost 4 years of experience developing and deploying AI and Data Solutions to production", image: "https://alvinrindra.github.io/assets/images/lhind.png" }},
                { data: { id: 'lead_data', name: "Lead Data Science", parent: 'working_exp', image: "/Users/alvinrindra/Documents/VINTZ/alvinrindra.github.io/assets/images/Azure_Public_Service_Icons/Icons/ai + machine learning/00030-icon-service-Machine-Learning-Studio-(Classic)-Web-Services.svg", desc: "As a lead data science instructor, leading a team of instructors in topics: AI, ML, DL, RL" }},
