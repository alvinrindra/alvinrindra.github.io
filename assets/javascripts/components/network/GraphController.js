    ...
    angular.module('autolinks.graph')
        ...
        function ($scope, $q, $rootScope, graphProperties, EntityService, _, $mdDialog, $mdToast, $timeout) {
          ...
          $scope.buildGraph = function() {
              ...
              var nodes = [
                //alvinrindra
                { data: { id: 'alvinrindra', name: 'alvinrindra', desc: "Data Science Enthusiast; Software Engineer with Machine Learning Expertise.", image: "https://alvinrindra.github.io/assets/images/Alvin_foto_1.jpg" } },
                //working_exps
                ...
                { data: { id: 'ai_specialist', name: "AI Specialist", parent: 'working_exp', image: "https://alvinrindra.github.io/assets/images/data_science/lhind.png" }},
