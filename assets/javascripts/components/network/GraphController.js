    ...
    angular.module('autolinks.graph')
        ...
        function ($scope, $q, $rootScope, graphProperties, EntityService, _, $mdDialog, $mdToast, $timeout) {
          ...
          $scope.buildGraph = function() {
              ...
              var nodes = [
                //alvinrindra
                { data: { id: 'alvinrindra', name: 'alvinrindra', desc: "Data Science Enthusiast with Machine Learning Expertise.", image: "https://alvinrindra.github.io/assets/images/Alvin_foto.jpg" } },
                //working_exps
