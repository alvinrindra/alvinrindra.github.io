    ...
    angular.module('autolinks.graph')
        ...
        function ($scope, $q, $rootScope, graphProperties, EntityService, _, $mdDialog, $mdToast, $timeout) {
          ...
          $scope.buildGraph = function() {
              ...
              var nodes = [
                //alvinrindra
                { data: { id: 'alvinrindra', name: 'alvinrindra', desc: "Sr. AI & Data Consultant | Sr. AI Architect | MLOps/LLMOps Lead", image: "https://alvinrindra.github.io/assets/images/Alvinfoto2.jpg" } },
                //working_exps
                ...
                { data: { id: "tensorflow", name: "Tensorflow/TFX", parent: 'tools', image: "https://alvinrindra.github.io/assets/images/machine_learning/tensorflow.jpeg" } },
                { data: { id: "kubeflow", name: "Kubeflow", parent: 'tools', image: "https://alvinrindra.github.io/assets/images/machine_learning/kubeflow.png" } },
                { data: { id: "shap", name: "SHAP Explainer", parent: 'tools', image: "https://alvinrindra.github.io/assets/images/machine_learning/shap.png" } },
                ...
                // { data: { id: 'ollama', name: "Ollama", parent: 'llm_deployment', image: "https://alvinrindra.github.io/assets/images/genai/ollama.png" } },

                // { data: { id: "big_data", name: "Big Data", parent: 'data_science_stack'  } },
                { data: { id: "tools", name: "ML/MLOps Tools", parent: 'data_science_stack'  } },
                ...
                { data: { id: "azure_ml", name: "AzureML", parent: 'tools', image: "https://alvinrindra.github.io/assets/images/machine_learning/azureml.png"  } },
                { data: { id: "synapse", name: "Azure Synapse", parent: 'tools', image: "https://alvinrindra.github.io/assets/images/machine_learning/synapse.png"  } },
                { data: { id: "sagemaker", name: "AWS Sagemaker", parent: 'tools', image: "https://alvinrindra.github.io/assets/images/machine_learning/sagemaker.png"  } },
                { data: { id: "vertexai", name: "Google VertexAI", parent: 'tools', image: "https://alvinrindra.github.io/assets/images/machine_learning/vertex.png"  } },
                ...
                { data: { id: 'paper_irl', name: "Interactive RL", parent: 'publications', image: "https://alvinrindra.github.io/assets/images/papers/interactive_RL.png", url: "https://ieeexplore.ieee.org/document/8329809", desc: "We review a number of proposed advising approaches for interactive reinforcement learning and discuss their implications, namely, probabilistic advising, early advising, importance advising, and mistake correcting. Moreover, we implement the advice strategies for interactive reinforcement learning based on a simulated robotic scenario of a domestic cleaning task. Tech stack: Python, numpy, matplotlib."} },
